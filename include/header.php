			...
			<ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
				...
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" href="best_sellbook.php">BEST SELL BOOK</a></li>
					<li><a class="dropdown-item" href="new_collection_book.php">NEW COLLECTION</a></li>
					<li><a class="dropdown-item" href="old_book.php">OLD BOOK</a></li>
					<li><a class="dropdown-item" href="get_donatebook.php">GET DONATE BOOK</a></li>
				</ul>
			  </li>
			   <li class="nav-item"><a class="nav-link" href="sellbook.php">SELL BOOK</a></li>
			    <li class="nav-item"><a class="nav-link" href="requestbook.php">REQUEST BOOK</a></li>
			    <li class="nav-item"><a class="nav-link" href="donatebook.php">DONATE  BOOK</a></li>
			    <li class="nav-item"><a class="nav-link" href="earnmoney.php">ERAN MONEY</a></li>
			  	...
			  	<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						...
						<li><a class="dropdown-item" href="donatebook.php">DONATE BOOKS</a></li>
