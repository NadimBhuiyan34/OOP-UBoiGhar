		...
		<div class="container text-center" style="margin-top: 120px;">
            ...
            <div class="row">
                  ...
                  <div class="col-3 card ">
                    <img src="images/about/azad.jpg" alt="" style="height:300px;" class="img-fluid">
                    <h4>Md Azad Hossain</h4> 
                    <p>Software Developer</p>
                  </div>
                  <div class="col-3 card ">
                    <img src="images/about/shuvo.png" alt="" style="height:300px;" class="img-fluid">
                    <h4>Shuvo Islam</h4> 
                    <p>Software Developer</p>
                  </div>
                  <div class="col-3 card ">
                    <img src="images/about/nadimimage.png" alt="" style="height:300px;" class="img-fluid">
                    <h4>Nadim Bhuiyan</h4>
                    <p>Software Developer</p>
                  </div>
                  <div class="col-3 card ">
                    <img src="images/about/EmranWhite.png" alt="" style="height:300px;" class="img-fluid">
                    <h4>Emran Hossain</h4>
                    <p>Software Developer</p>
                  </div>
            </div>
