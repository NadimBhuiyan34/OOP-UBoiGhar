		  ...
		  <div class="collapse navbar-collapse" id="navbarmain">
			<ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
				<a class="nav-link" href="home.html" id="dropdown02" data-toggle="">BUY BOOK <i class="icofont-thin-down"></i></a>
		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<span class="text-uppercase text-sm letter-spacing ">New Collection</span>
					<h1 class="mb-3 mt-3 text-white">New Collection with 50% OFF</h1>
					
					<p class="mb-4 pr-5">A repudiandae ipsam labore ipsa voluptatum quidem quae laudantium quisquam aperiam maiores sunt fugit, deserunt rem suscipit placeat.</p>
					<div class="btn-container ">
						<a href="requestbook.html" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Request Book<i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
 ...
 <!-- <div class="container mb-5">
	<div class="row">
		  <div class=" col-5 mt-5">
              <h3 class="text-center">Welcome to our University Boighar</h3>
			  <p class="text-dark">
		...
		<div class="col-7 mt-5">
			 <img src="images/about-right.png" alt="" style="margin-left:200px ;">
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<h4 class="mb-3">Online Book Order</h4>
						<p class="mb-4">Get ALl time support for emergency.We have introduced the principle of family medicine.</p>
						<a href="appoinment.html" class="btn btn-main btn-round-full">Request Book</a>
					</div>
...
<section class="gray-bg ">
	<section class="section service gray-bg ">
		<h1 class="text-center" style="margin-bottom: 100px;">DONATE BOOK</h1>
				   ...
				   <div class="service-item mb-4">
					   <div class="icon d-flex">
						...
						<div class="btn-group" role="group" aria-label="Basic example" style="margin-left:100px;">
							<a href="donate_bookdetails.html"><button type="button" class="btn btn-success fa-solid fa-eye"><span class="ml-2">View Details</span></button></a>
