...
<!-- Slider Start -->
	...
	<div class="container d-flex justify-content-center">
		 <div class="card ">
               <img src="images/dbook1.jpg" alt=""style="width:400px">
         </div>
		 <div class="card ml-3">
               <img src="images/donatebook1.jpg" alt=""style="width:400px;">
         </div>
	</div>
...
<div class="container">
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book title" placeholder="Full Name" class="form-control" autofocus>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book title" placeholder="Email" class="form-control" autofocus>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book title" placeholder="Address" class="form-control" autofocus>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book title" placeholder="Mobile" class="form-control" autofocus>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book title" placeholder="Book Title" class="form-control" autofocus>
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book author" placeholder="Book Author" class="form-control" autofocus>
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book edition" placeholder="Book Edition" class="form-control" autofocus>
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book quality" placeholder="Book Category" class="form-control" autofocus>
            </div>
        </div>
        ...
        <div class="form-group" style="padding-left: 20px; color: gray;">
          ...
          <div class="btn-group-toggle" data-toggle="buttons" style="margin-left: 50%;">
            <label class="btn btn-secondary active">
              <input type="checkbox" checked autocomplete="off"> PUBLISH
            </label>
          </div>
