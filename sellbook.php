...
use UBoiGhar\Sell_Book\demo1;
$sellinfo=new demo1("PHP Nadim","nadim","5th","2");
echo $sellinfo->get_name();    
...
<!-- Slider Start -->
<section class="">
	<img src="images/sell.jpg" alt="" style="width: 100%;">
</section>
...
<div class="container ">
    <form class="form-horizontal" role="form" action="sellbook.php" method="post">
        <h2>Sell Book</h2>
        <br>
        ...
        <div class="form-group" style="padding-left: 20px; color: gray;">
          ...
          <div class="btn-group-toggle" data-toggle="buttons" style="margin-left: 50%;">
            <label class="btn btn-secondary active">
              <input type="checkbox" checked autocomplete="off" name="submit">PUBLISH
            </label>
          </div>
