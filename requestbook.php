		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<span class="text-uppercase text-sm letter-spacing ">Request Book</span>
					<h1 class="mb-3 mt-3 text-white">Request for Book</h1>
					
				 
					<div class="btn-container ">
						<a href="appoinment.html" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Request Book<i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="container">
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <div class="col-sm-11">
                <input type="text" id="book quality" placeholder="Book Quality" class="form-control" autofocus>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-11">
                <input type="phoneNumber" id="phoneNumber" placeholder="Your Phone number" class="form-control">
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-11">
                <input type="text" id="addres" placeholder="Your Address" class="form-control">
        ...
        <div class="form-group" style="padding-left: 20px; color: gray;">
          ...
          <div class="btn-group-toggle" data-toggle="buttons" style="margin-left: 50%;">
            <label class="btn btn-secondary active">
              <input type="checkbox" checked autocomplete="off"> CONFIRM NOW
            </label>
          </div>
