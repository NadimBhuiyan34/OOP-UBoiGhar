			...
			<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
				<div class="carousel-inner">
				  <div class="carousel-item active">
					<img src="images/events/image2.jpg" class="d-block w-100" alt="..." style="height:300px ;">
				  </div>
				  <div class="carousel-item">
					<img src="images/events/image1.jpg" class="d-block w-100" alt="..."style="height:300px ;">
				  </div>
				  <div class="carousel-item">
					<img src="images/events/image4.jpg" class="d-block w-100" alt="..."style="height:300px ;">
				  </div>
				</div>
			  </div>
			  <!-- /carsoyul -->
	...
	<div class="d-flex  flex-md-row flex-sm-column flex-xm-column" style="margin-left:120px ;">
         <div class="col-5 card">
          ...
          <div class="card-body center">
			<img src="images/events/eventsthumb1.png" alt="" style="height: 200px;" class="img-fluid center">
